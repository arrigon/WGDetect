...
# Converts an aligned fasta (aa or dna) seq file to paml format (similar to phylip but name max 30 characters long)
...
my $totNumChar = 30;  # number of characters allowed for name in phylip
